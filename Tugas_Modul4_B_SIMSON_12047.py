...
st.set_page_config(
    page_title="12047- Unsupervised Learning", 
    page_icon="",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - SIMSON</h1>", unsafe_allow_html=True) 
    st.dataframe(input_data)

    model_directory = r'D:\Informatika\semester 5\Pembelajaran Mesin dan Pembelajaran Mendalam B\Unsupervised Learning (Praktek)\Unsupervised Learning (Praktek)\Tugas4_B_12047'
